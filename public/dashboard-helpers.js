 ...
 */
const _S =
  'xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.3"';
...
export const ACT_ICONS = {
  ...
  /*- Acorn: Compound activity entries.  User-provided art (white
   *  acorn + stem) on transparent background so the .aico container's
   *  tinted 10%-opacity chip shows through.  Rendered at 27×27 (50%
   *  larger than the 18×18 default so the shape reads at a glance);
   *  internal 64×64 viewBox preserved so the supplied coordinate math
  ...
  acorn: `<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 64 64"><ellipse cx="32" cy="39" rx="12" ry="15" fill="#FFFFFF"/><path d="M20 26 Q20 19 32 17 Q44 19 44 26 Q44 29 32 29 Q20 29 20 26" fill="#FFFFFF"/><path d="M23.5 23 Q32 21.2 40.5 23" fill="none" stroke="#0F3D2E" stroke-width="1.4" stroke-linecap="round"/><path d="M24.5 26 Q32 24.7 39.5 26" fill="none" stroke="#0F3D2E" stroke-width="1.4" stroke-linecap="round"/><path d="M32 17 Q33.5 11 32 7" fill="none" stroke="#FFFFFF" stroke-width="2.8" stroke-linecap="round"/></svg>`,
